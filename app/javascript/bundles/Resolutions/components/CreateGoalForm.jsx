...
const CreateGoalForm = () => {
  ...
  const onSubmit = data => {
    alert(`Form submitted with name: ${Object.values(data)}`);
  };
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col mt-2 text-xl">
        <div className="col-span-full mt-2">
          ...
          <div className="mt-2">
            <textarea {...register('title', { required: 'Title is required' })} className="block w-full rounded-md border-0 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-1.5"></textarea>
        ...
        <div className="col-span-full mt-2">
          ...
          <select {...register('comparator', { required: 'Comparator is required' })} className="block w-full rounded-md border-0 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-1.5">
            <option key='0'>Less Than</option>
